...
export const SelectField = ({
    ...
    const basicStyles: StylesConfig = {
        ...
        singleValue: (styles, { data, isDisabled }) => {
            ...
            return { ...styles, ...singleValueStyle, ...fontStyle, opacity, transition };
        },
        multiValue: (styles, { data, isDisabled }) => {
            const opacity = isDisabled ? 0.5 : 1;
            const transition = 'opacity 300ms';
            return { ...styles, ...multiValueStyle, ...fontStyle, opacity, transition };
        },
        multiValueLabel: (styles, { data, isDisabled }) => {
            const opacity = isDisabled ? 0.5 : 1;
            const transition = 'opacity 300ms';
            return { ...styles, ...multiValueLabelStyle, ...fontStyle, opacity, transition };
        },
    };
