...
export const IoIosArrowForward = withResponsiveSVG((props: NIcons.SVGProps) => {
    return (
        <svg
            stroke="currentColor"
            fill="currentColor"
...
export const RiErrorWarningFill = withResponsiveSVG((props: NIcons.SVGProps) => {
    return (
        <svg
            stroke="currentColor"
            fill="currentColor"
...
export const RiCheckboxCircleFill = withResponsiveSVG((props: NIcons.SVGProps) => {
    return (
        <svg
            stroke="currentColor"
            fill="currentColor"
...
export const MdInfo = withResponsiveSVG((props: NIcons.SVGProps) => {
    return (
        <svg
            stroke="currentColor"
            fill="currentColor"
...
export const MdClose = withResponsiveSVG((props: NIcons.SVGProps) => {
    return (
        <svg
            stroke="currentColor"
            fill="currentColor"
