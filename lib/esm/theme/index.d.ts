...
declare const Theme: {
    colors: {
        ...
        $buttonLinkHoverText: string;
        $buttonLinkActiveText: string;
        $buttonGhostText: string;
        $buttonGhostBackground: string;
        $buttonGhostHoverBackground: string;
        $buttonGhostActiveBackground: string;
        $linkActive: string;
        $anchorHoverText: string;
        $linkDefaultHoverText: string;
        $linkPrimaryText: string;
        $linkPrimaryHoverText: string;
        $iconLinkHoverBackground: string;
        $linkGhostText: string;
        $linkGhostHoverText: string;
        $linkGhostBackground: string;
        $radioPrimaryBackground: string;
        $tooltipTextDark: string;
        $tooltipTextLight: string;
        $tooltipBackgroundDark: string;
        $tooltipBackgroundLight: string;
...
export declare const LayoutContainer: import("styled-components").IStyledComponent<"web", {
